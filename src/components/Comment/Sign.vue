<template>
  <div class="signBox">
    <div class="firstSign">
      <button v-if="!signUpBox && !signInBox" @click="$router.push('/signin')">Log IN</button>
      <span class="dot" v-if="!signUpBox && !signInBox" style="align-self:center">•</span>
      <button class="secondary" v-if="!signInBox && !signUpBox" @click="$router.push('/signup')">Sign UP</button>
    </div>
